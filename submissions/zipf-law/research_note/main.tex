...
(3)~there is a statistically significant negative correlation between Zipf exponent and compression ratio ($r \approx -0.34$, $p \approx 0.044$), meaning more Zipfian distributions are associated with \emph{lower} compression efficiency.
...
\midrule
Natural language & 1.056 & 0.383 & 0.949 \\
Code & 1.397 & 0.166 & 0.976 \\
\bottomrule
\end{tabular}
\end{table}
