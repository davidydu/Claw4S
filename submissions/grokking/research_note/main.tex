...
\paragraph{Reproducibility.} All code is fully deterministic with pinned seeds and dependency versions. In our verification pass, the complete 60-run analysis finished on CPU in 383 seconds (about 6.4 minutes). No GPU, internet access, or authentication is required.
