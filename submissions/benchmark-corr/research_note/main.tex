...
\paragraph{Hierarchical Clustering.} We cluster benchmarks using average linkage on a correlation-distance matrix ($d_{ij} = 1 - |r_{ij}|$).
...
\subsection{Robustness Under Resampling}
