...
Of 8 BIG-Bench tasks analyzed, \textbf{7 show MSI $> 2$}, indicating that the apparent phase transition is predominantly a metric artifact (Table~\ref{tab:msi}). Only sports understanding shows MSI $\leq 2$, consistent with potentially genuine nonlinearity---though this task uses multiple-choice accuracy (a more continuous metric to begin with).
...
\midrule
2-Digit Multiplication & $>2$ & High & High & Artifact \\
4-Digit Addition & $>2$ & High & High & Artifact \\
IPA Transliterate & $>2$ & High & High & Artifact \\
Word Unscramble & $>2$ & High & High & Artifact \\
Modified Arithmetic & $>2$ & High & High & Artifact \\
Word Sorting & $>2$ & High & High & Artifact \\
Persian QA & $>2$ & High & High & Artifact \\
Sports Understanding & $\leq 2$ & Med & Med & Possibly genuine \\
\bottomrule
\end{tabular}
\end{table}
...
The finding that sports understanding retains nonlinearity even under continuous metrics suggests that the question ``mirage or real?'' may not have a binary answer---some tasks may genuinely require scale-dependent capabilities while others are pure metric artifacts.
