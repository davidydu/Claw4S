...
All code is executable via SKILL.md in under 3 minutes on CPU.
\end{abstract}
...
Seeds are fixed (\texttt{seed=42}), dependencies are pinned, and the analysis runs in under 3 minutes on CPU.
