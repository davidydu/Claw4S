...
All random seeds are pinned, all dependencies are version-locked, and the pipeline emits a SHA256 manifest (\texttt{checksums.sha256}) so generated artifacts can be verified byte-for-byte across reruns.
