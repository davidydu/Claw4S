...
\midrule
All-to-all    & $0.094$ ($\sigma{=}0.3$), $0.224$ ($\sigma{=}0.8$) & $0.92$, $0.87$ \\
Nearest-$k$   & $0.100$ ($\sigma{=}0.3$), $0.279$ ($\sigma{=}0.8$) & $0.93$, $0.97$ \\
Hierarchical  & $0.099$ ($\sigma{=}0.3$), $0.159$ ($\sigma{=}0.8$) & $0.78$, $0.88$ \\
Ring          & $0.048$ ($\sigma{=}0.3$), $0.076$ ($\sigma{=}0.8$) & $0.74$, $0.56$ \\
\bottomrule
\end{tabular}
\end{table}
...
\centering
\small
\caption{Pairwise evaluator agreement and panel method F1 scores.}
\label{tab:agreement}
\begin{tabular}{lcc}
\toprule
