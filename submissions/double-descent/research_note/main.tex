...
\paragraph{Reproducibility controls.} All dependencies are version-pinned in \texttt{requirements.txt}, every stochastic component is seeded, and the pipeline emits a SHA-256 fingerprint of scientific outputs. The validator recomputes this fingerprint from \texttt{results.json} to catch stale or corrupted artifacts before claims are made.
