...
\textbf{Weighted-by-History.} Ratings are weighted by rater account age: $w = \text{age}^2 + 1$. Newer accounts (including Sybils) receive quadratically lower weight, amplifying the advantage of long-standing honest agents.
...
\textbf{When account age helps and when it fails.}
