...
**Expected output:** 24 tests, all passing. Tests cover data generation, label noise injection, model construction, training convergence, and evaluation correctness.
